...
/*
 * This #define exists so shift generation functions can be shared with
 *  the shifter development and test program.  See the comment
 *  generated near the top of gen_h() which talks about other #defines;
